...
- **Manual trigger:** Can specify custom namespace (default: `sgahlot-test`)
...
**Deploy to OpenShift:**
- `namespace`: Target namespace (default: `sgahlot-test`)
...
**Deploy Workflow:**
- `namespace`: Target OpenShift namespace (default: `sgahlot-test`)
