...
4. **Container images**: Builds and pushes images to `quay.io/sgahlot/{IMAGE_PREFIX}-{component}:{version}` (e.g., `quay.io/sgahlot/aiobs-metrics-api:1.2.3`)
...
- `quay.io/sgahlot/aiobs-metrics-api:1.2.3`
- `quay.io/sgahlot/aiobs-metrics-ui:1.2.3`
- `quay.io/sgahlot/aiobs-metrics-vllm-alerting:1.2.3`
...
- **ORG**: `sgahlot` (registry organization)
